...
public class BilingualTooltipsClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ResourceLoader.get(PackType.CLIENT_RESOURCES).registerReloadListener(
                Identifier.fromNamespaceAndPath(BilingualConstants.MOD_ID, "translations"),
                (ResourceManagerReloadListener) resourceManager -> TranslationHolder.reload(resourceManager));
